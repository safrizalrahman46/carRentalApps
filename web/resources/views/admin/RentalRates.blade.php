    ...
    <script>
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                'ajax': {
                    'url': '{{ route('admin.Rental-Rates.index') }}',
                    'data': function(data) {
            ...
            $('body').on('click', '.editPost', function() {
                var id = $(this).data('id');
                $.get("{{ route('admin.Rental-Rates.index') }}" + '/' + id + '/edit', function(data) {
            ...
            $('#simpandata').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.Rental-Rates.store') }}",
                    type: "POST",
                    dataType: 'json',
            ...
            $('body').on('click', '.deletePost', function() {
                ...
                if (confirm("Apakah anda yakin ingin menghapus data ini ? ")) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('admin.Rental-Rates.store') }}" + '/' + id,
                        success: function(data) {
