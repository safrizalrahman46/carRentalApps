            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Delivery pickup Charge</h4>
    ...
    <script>
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('admin.Delivery-pickup-charges.index') }}',
                    data: function(data) {
            ...
            $('body').on('click', '.editPost', function() {
                var id = $(this).data('id');
                $.get("{{ route('admin.Delivery-pickup-charges.index') }}" + '/' + id + '/edit', function(data) {
            ...
            $('#simpandata').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.Delivery-pickup-charges.store') }}",
                    type: "POST",
                    dataType: 'json',
            ...
            $('body').on('click', '.deletePost', function() {
                ...
                if (confirm("Apakah anda yakin ingin menghapus data ini ? ")) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('admin.Delivery-pickup-charges.store') }}" + '/' + id,
                        success: function(data) {
