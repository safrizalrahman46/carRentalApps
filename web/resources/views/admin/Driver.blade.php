            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="postForm" name="postForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="expired_driving_license">Expired License Date</label>
                            <input type="datetime-local" class="form-control" id="expired_driving_license" name="expired_driving_license" required>
                        </div>
        ...
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [{
                    ...
                    { data: 'expired_driving_license', name: 'expired_driving_license' },
            ...
            $('body').on('click', '.editPost', function() {
                var id = $(this).data('id');
                $.get("{{ route('admin.Driver.index') }}" + '/' + id + '/edit', function(data) {
                    ...
                    $('#expired_driving_license').val(data.expired_driving_license);
            ...
            $('body').on('click', '.deletePost', function() {
                ...
                if (confirm("Apakah anda yakin ingin menghapus data ini ? ")) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('admin.Driver.store') }}" + '/' + id,
                        success: function(data) {
