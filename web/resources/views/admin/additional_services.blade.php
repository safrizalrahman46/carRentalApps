    ...
    <script>
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('admin.Additional-Service.index') }}',
                    data: function(data) {
            ...
            $('body').on('click', '.editPost', function() {
                var id = $(this).data('id');
                $.get("{{ route('admin.Additional-Service.index') }}" + '/' + id + '/edit', function(data) {
            ...
            $('#simpandata').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.Additional-Service.store') }}",
                    type: "POST",
                    dataType: 'json',
            ...
            $('body').on('click', '.deletePost', function() {
                ...
                if (confirm("Apakah anda yakin ingin menghapus data ini ? ")) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('admin.Additional-Service.store') }}" + '/' + id,
                        success: function(data) {
